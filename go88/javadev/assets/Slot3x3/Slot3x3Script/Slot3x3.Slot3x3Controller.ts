    ...
    start() {
        ...
        this.btnAuto.node.on("click", () => {
            ...
            if (this.isAuto) {
                ...
                this.btnAuto.getComponent(cc.Sprite).spriteFrame = LanguageLanguageManager.instance.languageCode=="vi"? this.sfAuto1:this.sfAuto1en;
            } else {
                this.btnBoost.interactable = true;
                this.btnAuto.getComponent(cc.Sprite).spriteFrame =LanguageLanguageManager.instance.languageCode=="vi"? this.sfAuto0:this.sfAuto0en;
                if (this.isSpined) {
        ...
        this.btnBoost.node.on("click", () => {
            ...
            if (this.isBoost) {
                ...
                this.btnBoost.getComponent(cc.Sprite).spriteFrame = LanguageLanguageManager.instance.languageCode=="vi"? this.sfBoost1:this.sfBoost1en;
            } else {
                this.btnAuto.interactable = true;
                this.btnBoost.getComponent(cc.Sprite).spriteFrame =LanguageLanguageManager.instance.languageCode=="vi"? this.sfBoost0:this.sfBoost0en;
                if (this.isSpined) {
                    this.setEnabledAllButtons(true);
                }
            }
