...
namespace Configs {
    ...
    export class App {
        ...
        static API: string = "https://iportal.jjbetwin.com/api";
		static API2: string = "https://iportal2.jjbetwin.com/api";
		static APIROY: string = "https://portal.jjbetwin.com/api";
        ...
        static readonly HOST_SOCKJS = "https://st.jjbetwin.com/";
