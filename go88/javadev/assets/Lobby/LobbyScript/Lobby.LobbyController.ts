...
if (!Configs.Login.IsLogin) {
        ...
        actOpenFB() {
            cc.sys.openURL("https://www.facebook.com/ROY88club/");
            // App.instance.openWebView("https://www.facebook.com/gaming/lote88com");
        }

        actOpenMessager() {
            cc.sys.openURL("https://m.me/ROY88club");
            // App.instance.openWebView("https://www.facebook.com/lote88com/inbox/");
        }
        actOpenZalo() {
            cc.sys.openURL("https://t.me/cskhROY88");
        }
        actOpenLive() {
            App.instance.openWebView("https://tawk.to/chat/621921afa34c2456412836c4/1fsp2n5p9");
        }
        ...
        actSupportOnline() {
            ...
            if (!cc.sys.isNative) {
                var url = "https://tawk.to/chat/621921afa34c2456412836c4/1fsp2n5p9";
                cc.sys.openURL(url);
                //Tawk_API.toggle();
            }
            else {
