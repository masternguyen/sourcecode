...
export default class Slot11Controller extends cc.Component {
                ...
                for (let i = 0; i < linesWin.length; i++) {
                    ...
                    actions.push(cc.callFunc(() => {
                        ...
                        for (let j = 0; j < mLine.length; j++) {
                            ...
                            if (fisrtItemId == itemId || (itemId == this.wildItemId && fisrtItemId > 3) || this.columnsWild.indexOf(j) >= 0) {
                                // //  cc.log("==" + itemId + " j:" + j);
                                countItemWin++;
                            } else {
                                break;
                        ...
                        for (let j = 0; j < countItemWin; j++) {
                            ...
                            let item = rolls[j].children[2 - itemRow].getComponent(Slot11Item);
        ...
        for (let i = 0; i < this.reels.childrenCount; i++) {
                ...
                cc.callFunc(() => {
                    ...
                    if (i == 4) {
                        ...
                        for (let j = 0; j < this.columnsWild.length; j++) {
                            ...
                            children[2].getComponent(Slot11Item).changeSpineIcon(this.wildItemId);
                            children[1].getComponent(Slot11Item).changeSpineIcon(this.wildItemId);
                            children[0].getComponent(Slot11Item).changeSpineIcon(this.wildItemId);
                        }
            ...
            TW(roll)
                ...
                .call(() => {
                    ...
                    listItemNode[2].getComponent(Slot11Item).changeSpineIcon(parseInt(matrix[i]));
                    listItemNode[1].getComponent(Slot11Item).changeSpineIcon(parseInt(matrix[5 + i]));
                    listItemNode[0].getComponent(Slot11Item).changeSpineIcon(parseInt(matrix[10 + i]));
                    listItemNode[listItemNode.length - 1].getComponent(Slot11Item).changeSpineIcon(parseInt(matrix[i]));
                    listItemNode[listItemNode.length - 2].getComponent(Slot11Item).changeSpineIcon(parseInt(matrix[5 + i]));
                    listItemNode[listItemNode.length - 3].getComponent(Slot11Item).changeSpineIcon(parseInt(matrix[10 + i]));
                    for (let m = 0; m < roll.childrenCount; m++) {
                        let item = roll.children[m].getComponent(Slot11Item);
    ...
    actSelectline() {
        ...
        if (this.popupSelectLine == null) {
            BundleControl.loadPrefabGame("Slot11Bikini", "prefabs/PopupSelectLine", (finish, total) => {
    ...
    actGuide() {
        ...
        if (this.popupGuide == null) {
            BundleControl.loadPrefabGame("Slot11Bikini", "prefabs/PopupGuide", (finish, total) => {
                // App.instance.showErrLoading(App.instance.getTextLang('txt_loading1') + parseInt((finish / total) * 100) + "%");
            }, prefab => {
                App.instance.showLoading(false);
    ...
    actHonor() {
        ...
        if (this.popupHonor == null) {
            BundleControl.loadPrefabGame("Slot11Bikini", "prefabs/PopupJackpotHistory", (finish, total) => {
                // App.instance.showErrLoading(App.instance.getTextLang('txt_loading1') + parseInt((finish / total) * 100) + "%");
            }, prefab => {
                App.instance.showLoading(false);
                this.popupHonor = cc.instantiate(prefab).getComponent(PopupJackpotHistory);
    ...
    actHistory() {
        ...
        if (this.popupHistory == null) {
            BundleControl.loadPrefabGame("Slot11Bikini", "prefabs/PopupHistory", (finish, total) => {
                // App.instance.showErrLoading(App.instance.getTextLang('txt_loading1') + parseInt((finish / total) * 100) + "%");
            }, prefab => {
                App.instance.showLoading(false);
    ...
    actShowBonus(isTrial, dataHaiSao, cb, numberIcon) {
        if (this.popupBonus == null) {
            BundleControl.loadPrefabGame("Slot11Bikini", "prefabs/PopupBonus", (finish, total) => {
                // App.instance.showErrLoading(App.instance.getTextLang('txt_loading1') + parseInt((finish / total) * 100) + "%");
            }, prefab => {
                App.instance.showLoading(false);
